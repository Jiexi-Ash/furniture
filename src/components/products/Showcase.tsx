        ...
        <div className="w-full flex  gap-6">
          ...
          <div className="w-[40%] h-[400px] flex justify-center flex-col gap-5">
            ...
            <p className="text-sm text-[#ccc] leading-5 tracking-wide">
              ...
              reiciendis culpa sit doloremque laudantium officiis possimus harum
              voluptatem ea, recusandae sed? Sequi sit, aut facilis reiciendis
              deleniti laudantium commodi dignissimos eligendi! Voluptatem vero
              ut, sequi porro, fugiat earum voluptatum eligendi, asperiores quod
              nesciunt culpa? Labore nam omnis voluptas dolor obcaecati eum.
            </p>
            <Link
              href="/products"
